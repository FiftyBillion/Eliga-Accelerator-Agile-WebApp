<template>
  ...
  <div class="text-center">
    <v-dialog v-model="dialog" width="500">
      ...
      <v-card>
        <v-card-title class="headline accent lighten-2" primary-title>Create a New Chart</v-card-title>
           <v-card-text>
             <v-form class="px-3" ref="form">
               ...
               <v-btn flat @click="submit" class="primary mx-0 mt-3">Add Chart</v-btn>
             </v-form>
       </v-card-text>
      </v-card>
    </v-dialog>
